  ...
  for (b_i = 0; b_i < i; b_i++) {
    ...
    if (d == 0.0) {
      ...
      if (d != 0.0) {
        ...
        i1 = (int32_T)d;
        if ((i1 < 1) || (i1 > 7)) {
          emlrtDynamicBoundsCheckR2012b(i1, 1, 7, &fc_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        if (LP_J_type[i1 - 1] == 'R') {
          Cz_tmp = d * 3.0;
          for (i2 = 0; i2 < 3; i2++) {
            ...
            if (b) {
              emlrtDynamicBoundsCheckR2012b(A_I_BB_tmp, 1, 21, &hc_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
      ...
      if (guard1 && (d != 0.0)) {
        ...
        if ((Cz_tmp_tmp < 1) || (Cz_tmp_tmp > 7)) {
          emlrtDynamicBoundsCheckR2012b(Cz_tmp_tmp, 1, 7, &gc_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        if (LP_J_type[Cz_tmp_tmp - 1] == 'L') {
          ...
          for (i2 = 0; i2 < 3; i2++) {
            ...
            if (b) {
              emlrtDynamicBoundsCheckR2012b(c_A_I_BB_tmp, 1, 21, &ic_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }

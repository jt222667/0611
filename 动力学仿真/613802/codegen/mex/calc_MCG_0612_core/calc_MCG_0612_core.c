                    ...
                    const real_T q[7], emxArray_real_T *M, emxArray_real_T *G)
{
  ...
  for (i = 0; i < loop_ub; i++) {
    ...
    if (((int8_T)alpha1 < 1) || ((int8_T)alpha1 > 7)) {
      emlrtDynamicBoundsCheckR2012b((int8_T)alpha1, 1, 7, &ab_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
  ...
  for (b_i = 0; b_i < 7; b_i++) {
    ...
    while (alpha1 != 0.0) {
      ...
      if (((int32_T)alpha1 < 1) || ((int32_T)alpha1 > 7)) {
        emlrtDynamicBoundsCheckR2012b((int32_T)alpha1, 1, 7, &bb_emlrtBCI,
                                      &b_st);
      }
    ...
    for (j = 0; j < b_loop_ub; j++) {
      ...
      if (c_y) {
        ...
        for (i = 0; i < 3; i++) {
          ...
          c_y = ((d1 < 1.0) || (d1 > 21.0));
          if (c_y) {
            emlrtDynamicBoundsCheckR2012b((int32_T)d1, 1, 21, &cb_emlrtBCI,
                                          &st);
          }
          ...
          if (c_y) {
            emlrtDynamicBoundsCheckR2012b(loop_ub_tmp, 1, 21, &cb_emlrtBCI,
                                          &st);
          }
        ...
        if (((int32_T)alpha1 < 1) || ((int32_T)alpha1 > 7)) {
          emlrtDynamicBoundsCheckR2012b((int32_T)alpha1, 1, 7, &u_emlrtBCI,
                                        &st);
        }
  ...
  if (loop_ub < 3200) {
    for (i = 0; i < loop_ub; i++) {
      ...
      if (((int32_T)n < 1) || ((int32_T)n > 7)) {
        emlrtDynamicBoundsCheckR2012b((int32_T)n, 1, 7, &d_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
      ...
      for (i = 0; i < loop_ub; i++) {
        ...
        if (setjmp(emlrtJBEnviron) == 0) {
          ...
          if (((int32_T)d < 1) || ((int32_T)d > 7)) {
            emlrtDynamicBoundsCheckR2012b((int32_T)d, 1, 7, &d_emlrtBCI, &st);
          }

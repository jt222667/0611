 ...
 *
 * _coder_calc_MCG_0612_core_api.c
 *
 * Code generation for function '_coder_calc_MCG_0612_core_api'
 *
 */
...
static emlrtRTEInfo fb_emlrtRTEI = {
    1,                               /* lineNo */
    1,                               /* colNo */
    "_coder_calc_MCG_0612_core_api", /* fName */
    ""                               /* pName */
};
...
static cell_wrap_1 bb_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u,
                                       const emlrtMsgIdentifier *parentId);
...
void calc_MCG_0612_core_api(const mxArray *const prhs[4], int32_T nlhs,
                            const mxArray *plhs[3])
{
  ...
  q = db_emlrt_marshallIn(&st, emlrtAlias(prhs[2]), "q");
  qd = db_emlrt_marshallIn(&st, emlrtAlias(prhs[3]), "qd");
  /* Invoke the target function */
  emxInit_real_T(&st, &M, 2, &fb_emlrtRTEI);
  emxInit_real_T(&st, &C, 2, &fb_emlrtRTEI);
  emxInit_real_T(&st, &G, 1, &fb_emlrtRTEI);
  calc_MCG_0612_core(&st, &LP, &SV, *q, *qd, M, C, G);
...
/* End of code generation (_coder_calc_MCG_0612_core_api.c) */

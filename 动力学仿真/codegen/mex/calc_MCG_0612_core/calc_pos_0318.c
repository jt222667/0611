    ...
    i_emlrtRTEI =
        {
            ...
            "calc_pos_0318", /* fName */
            "F:\\Archive "
            "\xe5\xbd\x92\xe6\xa1\xa3\\0611\\myproblem\\Kinematic\\calc_pos_"
            "0318.m" /* pName */
};
                   ...
                   const real_T LP_SN[10], struct2_T *SV)
{
  ...
  for (b_i = 0; b_i < i; b_i++) {
    ...
    if (d == 0.0) {
      ...
      if (d1 != A_I_BB_tmp) {
        emlrtIntegerCheckR2012b(d1, &ib_emlrtDCI, (emlrtConstCTX)sp);
      }
      c_A_I_BB_tmp = (int32_T)d1;
      if ((c_A_I_BB_tmp < 1) || (c_A_I_BB_tmp > 3)) {
        emlrtDynamicBoundsCheckR2012b(c_A_I_BB_tmp, 1, 3, &sb_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
      /*  计算绕z轴旋转的余弦矩阵 */
      Cz_tmp = LP_align[b_i];
      ...
      if (LP_J_type[b_i] == 'R') {
        ...
        if (c_A_I_BB_tmp != A_I_BB_tmp) {
          emlrtIntegerCheckR2012b(d1, &jb_emlrtDCI, (emlrtConstCTX)sp);
        }
        if (LP_module[b_i] != (int32_T)muDoubleScalarFloor(LP_module[b_i])) {
          emlrtIntegerCheckR2012b(LP_module[b_i], &kb_emlrtDCI,
                                  (emlrtConstCTX)sp);
        }
        c_A_I_BB_tmp = (int32_T)LP_module[b_i];
        if ((c_A_I_BB_tmp < 1) || (c_A_I_BB_tmp > 10)) {
          emlrtDynamicBoundsCheckR2012b(c_A_I_BB_tmp, 1, 10, &tb_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        ...
        if (LP_module[b_i] != (int32_T)muDoubleScalarFloor(LP_module[b_i])) {
          emlrtIntegerCheckR2012b(LP_module[b_i], &mb_emlrtDCI,
                                  (emlrtConstCTX)sp);
        }
        c_A_I_BB_tmp = (int32_T)LP_module[b_i];
        if ((c_A_I_BB_tmp < 1) || (c_A_I_BB_tmp > 10)) {
          emlrtDynamicBoundsCheckR2012b(c_A_I_BB_tmp, 1, 10, &ub_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        memset(&b_A_I_BB[0], 0, 9U * sizeof(real_T));
        memset(&c_A_I_BB[0], 0, 3U * sizeof(real_T));
      ...
      if (d != 0.0) {
        ...
        i1 = (int32_T)d;
        if ((i1 < 1) || (i1 > 10)) {
          emlrtDynamicBoundsCheckR2012b(i1, 1, 10, &fc_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        if (LP_J_type[i1 - 1] == 'R') {
          Cz_tmp = d * 3.0;
          for (i2 = 0; i2 < 3; i2++) {
            ...
            if (c_Cz_tmp != (int32_T)c_Cz_tmp) {
              emlrtIntegerCheckR2012b(c_Cz_tmp, &dc_emlrtDCI,
                                      (emlrtConstCTX)sp);
            }
            b = ((c_Cz_tmp < 1.0) || (c_Cz_tmp > 30.0));
            if (b) {
              emlrtDynamicBoundsCheckR2012b((int32_T)c_Cz_tmp, 1, 30,
            ...
            if (b) {
              emlrtDynamicBoundsCheckR2012b(A_I_BB_tmp, 1, 30, &hc_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
          ...
          if (LP_J_type[b_i] == 'R') {
            ...
            if (b_Cz_tmp != (int32_T)muDoubleScalarFloor(b_Cz_tmp)) {
              emlrtIntegerCheckR2012b(b_Cz_tmp, &ob_emlrtDCI,
                                      (emlrtConstCTX)sp);
            }
            ...
            if (b_Cz_tmp != (int32_T)muDoubleScalarFloor(b_Cz_tmp)) {
              emlrtIntegerCheckR2012b(b_Cz_tmp, &pb_emlrtDCI,
                                      (emlrtConstCTX)sp);
            }
            if (((int32_T)b_Cz_tmp < 1) || ((int32_T)b_Cz_tmp > 10)) {
              emlrtDynamicBoundsCheckR2012b((int32_T)b_Cz_tmp, 1, 10,
            ...
            if (LP_module[b_i] !=
              ...
              emlrtIntegerCheckR2012b(LP_module[b_i], &qb_emlrtDCI,
                                      (emlrtConstCTX)sp);
            }
            Cz_tmp_tmp = (int32_T)LP_module[b_i];
            if ((Cz_tmp_tmp < 1) || (Cz_tmp_tmp > 10)) {
              emlrtDynamicBoundsCheckR2012b(Cz_tmp_tmp, 1, 10, &xb_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            if (i1 != b_A_I_BB_tmp) {
            ...
            if (d1 != (int32_T)muDoubleScalarFloor(d1)) {
              emlrtIntegerCheckR2012b(d1, &sb_emlrtDCI, (emlrtConstCTX)sp);
            }
            if (((int32_T)d1 < 1) || ((int32_T)d1 > 10)) {
              emlrtDynamicBoundsCheckR2012b((int32_T)d1, 1, 10, &yb_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            if (i1 != b_A_I_BB_tmp) {
            ...
            if (((int32_T)d1 < 1) || ((int32_T)d1 > 10)) {
              emlrtDynamicBoundsCheckR2012b((int32_T)d1, 1, 10, &ac_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            /*  计算绕z轴旋转的余弦矩阵 */
            c_Cz_tmp = LP_align[b_i];
            ...
            if (LP_module[b_i] !=
                (int32_T)muDoubleScalarFloor(LP_module[b_i])) {
              emlrtIntegerCheckR2012b(LP_module[b_i], &ub_emlrtDCI,
                                      (emlrtConstCTX)sp);
            }
            Cz_tmp_tmp = (int32_T)LP_module[b_i];
            if ((Cz_tmp_tmp < 1) || (Cz_tmp_tmp > 10)) {
              emlrtDynamicBoundsCheckR2012b(Cz_tmp_tmp, 1, 10, &bc_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            if (i1 != b_A_I_BB_tmp) {
      ...
      if (guard1 && (d != 0.0)) {
        ...
        if ((Cz_tmp_tmp < 1) || (Cz_tmp_tmp > 10)) {
          emlrtDynamicBoundsCheckR2012b(Cz_tmp_tmp, 1, 10, &gc_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        if (LP_J_type[Cz_tmp_tmp - 1] == 'L') {
          ...
          for (i2 = 0; i2 < 3; i2++) {
            ...
            if (Cz_tmp != (int32_T)Cz_tmp) {
              emlrtIntegerCheckR2012b(Cz_tmp, &ec_emlrtDCI, (emlrtConstCTX)sp);
            }
            b = ((Cz_tmp < 1.0) || (Cz_tmp > 30.0));
            if (b) {
              emlrtDynamicBoundsCheckR2012b((int32_T)Cz_tmp, 1, 30,
            ...
            if (b) {
              emlrtDynamicBoundsCheckR2012b(c_A_I_BB_tmp, 1, 30, &ic_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
          ...
          if (LP_J_type[b_i] == 'R') {
            if (LP_module[b_i] !=
                (int32_T)muDoubleScalarFloor(LP_module[b_i])) {
              emlrtIntegerCheckR2012b(LP_module[b_i], &vb_emlrtDCI,
                                      (emlrtConstCTX)sp);
            }
            c_A_I_BB_tmp = (int32_T)LP_module[b_i];
            if ((c_A_I_BB_tmp < 1) || (c_A_I_BB_tmp > 10)) {
              emlrtDynamicBoundsCheckR2012b(c_A_I_BB_tmp, 1, 10, &cc_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            ...
            if (LP_module[b_i] !=
                (int32_T)muDoubleScalarFloor(LP_module[b_i])) {
              emlrtIntegerCheckR2012b(LP_module[b_i], &wb_emlrtDCI,
                                      (emlrtConstCTX)sp);
            }
            c_A_I_BB_tmp = (int32_T)LP_module[b_i];
            if ((c_A_I_BB_tmp < 1) || (c_A_I_BB_tmp > 10)) {
              emlrtDynamicBoundsCheckR2012b(c_A_I_BB_tmp, 1, 10, &dc_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
